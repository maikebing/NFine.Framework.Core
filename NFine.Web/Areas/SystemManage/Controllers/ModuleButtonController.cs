...
namespace NFine.Web.Areas.SystemManage.Controllers
{
    public class ModuleButtonController : BaseController
    {
        ...
        public ActionResult GetTreeSelectJson(string moduleId)
        {
            ...
            foreach (sys_ModuleButtonEntity item in data)
            {
        ...
        public ActionResult SubmitForm(sys_ModuleButtonEntity moduleButtonEntity, string keyValue)
        {
        ...
        public ActionResult GetCloneButtonTreeJson()
        {
            ...
            foreach (sys_ModuleEntity item in moduledata)
            {
            ...
            foreach (sys_ModuleButtonEntity item in buttondata)
            {
                TreeViewModel tree = new TreeViewModel();
